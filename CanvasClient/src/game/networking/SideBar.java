...
public class SideBar extends JPanel {
    ...
    private JPanel names() {
        ...
        namesPanel.setLayout(new GridLayout(12,1)); // change this 12 if you want to make the sizes of each username box bigger/smaller
    ...
    public static void main(String[] args) throws Exception {
        ...
        players2.get(2).setGuessedWordCorrectly(true);
